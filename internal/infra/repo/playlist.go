...
func (r *PlaylistRepo) GetUserPlaylist(ctx context.Context, playlistId string, userId int64) (entity.Playlist, error) {
...
func (r *PlaylistRepo) GetAllByUser(ctx context.Context, userId int64) ([]entity.Playlist, error) {
...
func (r *PlaylistRepo) BuildDTO(ctx context.Context, pl entity.Playlist, tr *TrackRepo) (dto.Playlist, error) {
	// Resolve track DTOs
